					...
					<div class="news_post_container">
						...
						<div class="news_post">
							<div class="news_post_image">
								<img src="<?= base_url(RECURSOS_PORTAL_IMAGES.'morelos1.png');?>">
							</div>
							<div class="news_post_top d-flex flex-column flex-sm-row">
								...
								<div class="news_post_title_container">
									<div class="news_post_title">
										<a href="news_post.html">José María Morelos</a>
									</div>
							...
							<div class="news_post_text">
								<p> (José María Morelos y Pavón; Valladolid, actual Morelia, 1765 - San Cristóbal Ecatepec, 1815) Religioso, político y militar mexicano, caudillo de la independencia de México. Asumió el liderazgo del movimiento independentista tras la muerte en 1811 del cura Hidalgo (a cuya causa se había unido en 1810) y obtuvo importantes victorias. Con buena parte del sur del país bajo su control, Morelos trató además de dar forma política a sus ideales de justicia e igualdad a través del Congreso de Chilpancingo (1813), que formuló la declaración de independencia, otorgó a Morelos un amplio poder ejecutivo y puso las bases para una Constitución liberal y democrática que sería aprobada en 1814.<br><br>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/m20ycGQ1h08" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
