...
class Otro_lado_1 extends BaseController
{
    ...
    {
        return $this->Crear_vista('Portal/el_otro_lado_de_la_historia/otro_lado_1', $this->cargar_datos());
    }//cierra el index
    ...
    private function cargar_datos()//Declaración arreglo de 
    {
        $datos = array();
        //
        $datos['Nombre_pagina'] = 'otro_lado_1';
